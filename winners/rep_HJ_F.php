...
*/
	...
	$sql = "SELECT `result_hj_F`.`chest` , `result_hj_F`.`score` , `roll` , `name` , `batch`
FROM `result_hj_F`. , `STUDENT` WHERE `result_hj_F`.`chest` = `STUDENT`.`CHEST` AND `result_hj_F`.`score` != 0 ORDER BY `result_hj_F`.`score` DESC LIMIT 0 , 5";
             ...
             <!--header section-->
               <div class="header" class="row">
                ...
                <!-- Registration form -->
                 ...
                 <div id="legend">
                <h3 class="text-center" class="subhead"> HIGH JUMP (FEMALE) </h3>
                </div>
                <!--Name-->
