...
*/
	...
	$sql = "SELECT `result_hj_M`.`chest` , `result_hj_M`.`score` , `roll` , `name` , `batch`
FROM `result_hj_M`. , `STUDENT` WHERE `result_hj_M`.`chest` = `STUDENT`.`CHEST` AND `result_hj_M`.`score` != 0 ORDER BY `result_hj_M`.`score` DESC LIMIT 0 , 5";
             ...
             <!--header section-->
               <div class="header" class="row">
                ...
                <!-- Registration form -->
                 ...
                 <div id="legend">
                <h3 class="text-center" class="subhead"> HIGH JUMP (MALE) </h3>
                </div>
                <!--Name-->
