...
*/
	...
	$sql = "SELECT `result_trip_F`.`chest` , `result_trip_F`.`score` , `roll` , `name` , `batch`
FROM `result_trip_F`. , `STUDENT` WHERE `result_trip_F`.`chest` = `STUDENT`.`CHEST` AND `result_trip_F`.`score` != 0 ORDER BY `result_trip_F`.`score` DESC LIMIT 0 , 5";
             ...
             <!--header section-->
               <div class="header" class="row">
                ...
                <!-- Registration form -->
                 ...
                 <div id="legend">
                <h3 class="text-center" class="subhead"> TRIPLE JUMP (FEMALE) </h3>
                </div>
                <!--Name-->
