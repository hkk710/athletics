...
*/
	...
	$sql = "SELECT `result_trip_M`.`chest` , `result_trip_M`.`score` , `roll` , `name` , `batch`
FROM `result_trip_M`. , `STUDENT` WHERE `result_trip_M`.`chest` = `STUDENT`.`CHEST` AND `result_trip_M`.`score` != 0 ORDER BY `result_trip_M`.`score` DESC LIMIT 0 , 5";
             ...
             <!--header section-->
               <div class="header" class="row">
                ...
                <!-- Registration form -->
                 ...
                 <div id="legend">
                <h3 class="text-center" class="subhead"> TRIPLE JUMP (MALE) </h3>
                </div>
                <!--Name-->
