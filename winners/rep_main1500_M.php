...
*/
	...
	FROM `result_1500M` , `STUDENT` WHERE `result_1500M`.`chest` = `STUDENT`.`CHEST` AND `result_1500M`.`time` != 0 
	ORDER BY `result_1500M`.`time` ASC
	LIMIT 0 , 5";
             ...
             <!--header section-->
               <div class="header" class="row">
                ...
                <!-- Registration form -->
                 ...
                 <div id="legend">
                <h3 class="text-center" class="subhead"> 1500 metre (MALE) </h3>
                </div>
                <!--Name-->
