...
*/
	...
	$sql = "SELECT `result_hurdles_400M`.`chest` , `result_hurdles_400M`.`time` , `roll` , `name` , `batch`
	FROM `result_hurdles_400M` , `STUDENT` WHERE `result_hurdles_400M`.`chest` = `STUDENT`.`CHEST` AND `result_hurdles_400M`.`time` != 0 
	ORDER BY `result_hurdles_400M`.`time` ASC
	LIMIT 0 , 5";
             ...
             <!--header section-->
               <div class="header" class="row">
                ...
                <!-- Registration form -->
                 ...
                 <div id="legend">
                <h3 class="text-center" class="subhead"> 400 metre HURDLES (MALE) </h3>
                </div>
                <!--Name-->
