...
*/
	...
	$sql = "SELECT `result_100F`.`chest` , `result_100F`.`time` , `roll` , `name` , `batch`
	FROM `result_100F` , `STUDENT` WHERE `result_100F`.`chest` = `STUDENT`.`CHEST` AND `result_100F`.`time` != 0 
	ORDER BY `result_100F`.`time` ASC
	LIMIT 0 , 5";
             ...
             <!--header section-->
               <div class="header" class="row">
                ...
                <!-- Registration form -->
                 ...
                 <div id="legend">
                <h3 class="text-center" class="subhead"> 100 metre (FEMALE) </h3>
                </div>
                <!--Name-->
