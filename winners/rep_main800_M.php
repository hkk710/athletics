...
*/
	...
	$sql = "SELECT `result_800M`.`chest` , `result_800M`.`time` , `roll` , `name` , `batch`
	FROM `result_800M` , `STUDENT` WHERE `result_800M`.`chest` = `STUDENT`.`CHEST` AND `result_800M`.`time` != 0 
	ORDER BY `result_800M`.`time` DESC
	LIMIT 0 , 5";
             ...
             <!--header section-->
               <div class="header" class="row">
                ...
                <!-- Registration form -->
                 ...
                 <div id="legend">
                <h3 class="text-center" class="subhead"> 800 metre (MALE) </h3>
                </div>
                <!--Name-->
