...
<?php
	...
	$sql = "SELECT `result_discuss_m`.`chest` , `score` , `roll` , `name` , `batch`
	FROM `result_discuss_m` , `STUDENT` WHERE `result_discuss_m`.`chest` = `STUDENT`.`CHEST`
	ORDER BY `result_discuss_m`.`score` DESC
	LIMIT 0 , 5";
