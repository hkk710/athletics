             ...
             <!--header section-->
               <div class="header" class="row">
                   <div class="col-md-12" id="head-content">
                        <center><img src="../images/header.png"/ style="width:200px"></center>
                   </div>
               </div>
                <!-- Registration form
                 -->
...
<table class="table table-striped table-bordered table-hover">
	...
	<h2><b> Electronics and Communication Engineering</h2>
<br>
...
FROM `STUDENT`
WHERE `STUDENT`.`CHEST` BETWEEN 251 AND 400 ORDER BY `STUDENT`.`name` " ;
