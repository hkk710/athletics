...
$querya="UPDATE `DEPT_FE` SET `SCORE`=(SELECT SUM(`STUDENT`.`SCORE`) FROM `STUDENT` WHERE  `batch`='2' AND `gender`='female') WHERE  `DEPT`='2'";
$queryb="UPDATE `DEPT_FE` SET `SCORE`=(SELECT SUM(`STUDENT`.`SCORE`) FROM `STUDENT` WHERE  `batch`='1' AND `gender`='female') WHERE  `DEPT`='1'";
$queryc="UPDATE `DEPT_FE` SET `SCORE`=(SELECT SUM(`STUDENT`.`SCORE`) FROM `STUDENT` WHERE  `batch`='3' AND `gender`='female') WHERE  `DEPT`='3'";
...
a
               ...
               <div class="header" class="row">
                ...
                <div class="col-md-10">
					...
					<br><br><br>
						...
						<h2>  OVERALL DEPARTMENT SCORE ( FEMALE )
</h2>
 ...
 <tr>
	...
	$sql = "SELECT * FROM `DEPT_FE` ORDER BY `SCORE` desc ";
...
//echo "hello";
		...
		//		    echo "0 results";
			...
			?>
				...
				<br><br>
<h1><center>FEMALE CHAMPIONS</center></h1>
			<table class="table table-striped table-bordered table-hover">
 <tr>
	...
	$sql = "SELECT `name`,`gender`,`CHEST`,`batch`,`SCORE` FROM `STUDENT` WHERE (`STUDENT`.`CHEST`>506 AND `STUDENT`.`CHEST`<599 OR `STUDENT`.`CHEST`>606 AND `STUDENT`.`CHEST`<699 OR `STUDENT`.`CHEST`>706 AND `STUDENT`.`CHEST`<799) AND `gender`='female' ORDER BY `SCORE` DESC LIMIT 15 ";
