...
$score=0;
	...
	$insert1_query = "INSERT INTO `athletics`.`result_relay400_f`(`CHEST`, `SCORE`) VALUES ('$chest1','$dist1')";
	$insert2_query = "INSERT INTO `athletics`.`result_relay400_f`(`CHEST`, `SCORE`) VALUES ('$chest2','$dist2')";
	$insert3_query = "INSERT INTO `athletics`.`result_relay400_f`(`CHEST`, `SCORE`) VALUES ('$chest3','$dist3')";
