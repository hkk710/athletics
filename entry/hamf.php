...
$score=0;
	...
	$insert1_query = "INSERT INTO `athletics`.`result_hammer_f`(`chest`, `score`) VALUES ('$chest1','$dist1')";
	$insert2_query = "INSERT INTO `athletics`.`result_hammer_f`(`chest`, `score`) VALUES ('$chest2','$dist2')";
	$insert3_query = "INSERT INTO `athletics`.`result_hammer_f`(`chest`, `score`) VALUES ('$chest3','$dist3')";
	$insert4_query = "INSERT INTO `athletics`.`result_hammer_f`(`chest`, `score`) VALUES ('$chest4','$dist4')";
	$insert5_query = "INSERT INTO `athletics`.`result_hammer_f`(`chest`, `score`) VALUES ('$chest5','$dist5')";
