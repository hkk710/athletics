...
$score=0;
	...
	$insert1_query = "INSERT INTO `athletics`.`QUAL_100M`(`CHEST`, `TIME`) VALUES ('$chest1','$dist1')";
	$insert2_query = "INSERT INTO `athletics`.`QUAL_100M`(`CHEST`, `TIME`) VALUES ('$chest2','$dist2')";
	$insert3_query = "INSERT INTO `athletics`.`QUAL_100M`(`CHEST`, `TIME`) VALUES ('$chest3','$dist3')";
