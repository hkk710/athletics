...
$score=0;
	...
	$dist4 = $_POST["distance_no4"];
	$dist5 = $_POST["distance_no5"];
	
	$insert1_query = "INSERT INTO `athletics`.`result_discuss_m`(`chest`, `score`) VALUES ('$chest1','$dist1')";
	$insert2_query = "INSERT INTO `athletics`.`result_discuss_m`(`chest`, `score`) VALUES ('$chest2','$dist2')";
	$insert3_query = "INSERT INTO `athletics`.`result_discuss_m`(`chest`, `score`) VALUES ('$chest3','$dist3')";
	$insert4_query = "INSERT INTO `athletics`.`result_discuss_m`(`chest`, `score`) VALUES ('$chest4','$dist4')";
	$insert5_query = "INSERT INTO `athletics`.`result_discuss_m`(`chest`, `score`) VALUES ('$chest5','$dist5')";
