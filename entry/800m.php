...
$score=0;
	...
	$insert4_query = "INSERT INTO `athletics`.`result_800M`(`chest`, `time`) VALUES ('$chest4','$dist4')";
	$insert5_query = "INSERT INTO `athletics`.`result_800M`(`chest`, `time`) VALUES ('$chest5','$dist5')";
