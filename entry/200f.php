...
$score=0;
	...
	$insert4_query = "INSERT INTO `athletics`.`result_200F`(`chest`, `time`) VALUES ('$chest4','$dist4')";
	$insert5_query = "INSERT INTO `athletics`.`result_200F`(`chest`, `time`) VALUES ('$chest5','$dist5')";
