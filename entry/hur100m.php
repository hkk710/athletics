...
$score=0;
	...
	$insert1_query = "INSERT INTO `athletics`.`result_hurdles_100M`(`chest`, `time`) VALUES ('$chest1','$dist1')";
	$insert2_query = "INSERT INTO `athletics`.`result_hurdles_100M`(`chest`, `time`) VALUES ('$chest2','$dist2')";
	$insert3_query = "INSERT INTO `athletics`.`result_hurdles_100M`(`chest`, `time`) VALUES ('$chest3','$dist3')";
	$insert4_query = "INSERT INTO `athletics`.`result_hurdles_100M`(`chest`, `time`) VALUES ('$chest4','$dist4')";
	$insert5_query = "INSERT INTO `athletics`.`result_hurdles_100M`(`chest`, `time`) VALUES ('$chest5','$dist5')";
