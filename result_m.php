...
$querya="UPDATE `DEPT_M` SET `SCORE`=(SELECT SUM(`STUDENT`.`SCORE`) FROM `STUDENT` WHERE  `batch`='2' AND `gender`='male') WHERE  `DEPT`='2'";
$queryb="UPDATE `DEPT_M` SET `SCORE`=(SELECT SUM(`STUDENT`.`SCORE`) FROM `STUDENT` WHERE  `batch`='1' AND `gender`='male') WHERE  `DEPT`='1'";
$queryc="UPDATE `DEPT_M` SET `SCORE`=(SELECT SUM(`STUDENT`.`SCORE`) FROM `STUDENT` WHERE  `batch`='3' AND `gender`='male') WHERE  `DEPT`='3'";
   ...
   <script src="js/reg_form.min.js"></script>
	<script type="text/javascript">
             function reload(){
              ...
              console.log("reload");
               window.location.href="result_f.php";
              },100000);
          }
reload();
     </script>
...
a
               ...
               <div class="header" class="row">
                ...
                <div class="col-md-10">
					...
					<br><br><br>
						...
						<h2>  OVERALL DEPARTMENT SCORE ( MALE )
</h2>
 ...
 <tr>
	...
	$sql = "SELECT * FROM `DEPT_M` ORDER BY `SCORE` desc ";
...
//echo "hello";
		...
		//		    echo "0 results";
			...
			?>
				...
				<br><br>
<h1><center>MALE CHAMPIONS</center></h1>
			<table class="table table-striped table-bordered table-hover">
 <tr>
	...
	$sql = "SELECT `name`,`gender`,`CHEST`,`batch`,`SCORE` FROM `STUDENT` WHERE (`STUDENT`.`CHEST`>506 AND `STUDENT`.`CHEST`<599 OR `STUDENT`.`CHEST`>606 AND `STUDENT`.`CHEST`<699 OR `STUDENT`.`CHEST`>706 AND `STUDENT`.`CHEST`<799) AND `gender`='male' ORDER BY `SCORE` DESC LIMIT 15 ";
