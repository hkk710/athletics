...
<?php
	...
	$sql = "SELECT `discuss_M`.`chest` , `discuss_M`.`id` ,`STUDENT`.`roll` ,`STUDENT`.`naMe` ,`STUDENT`.`batch`
FROM `discuss_M` , `STUDENT` WHERE `discuss_M`.`chest` = `STUDENT`.`CHEST`
ORDER BY `discuss_m`.`id`
LIMIT 0 , 3";
...
<head>
    ...
    <!-- Latest compiled and minimied CSS -->
             ...
             <!--header section-->
               <div class="header" class="row">
                ...
                <!-- Registration form -->
                 ...
                 <div id="legend">
                <h3 class="text-center" class="subhead"><b> Discuss Throw (MALE)</b> </h3>
                </div>
                <!--Name-->
