...
FROM `result_hurdles_400M` , `STUDENT` WHERE `result_hurdles_400M`.`chest` = `STUDENT`.`CHEST`
ORDER BY `result_hurdles_400M`.`time`
LIMIT 0 , 5";
             ...
             <!--header section-->
               <div class="header" class="row">
                ...
                <!-- Registration form -->
                 ...
                 <div id="legend">
                <h3 class="text-center" class="subhead"> HURDLES 400m (MALE) </h3>
                </div>
                <!--Name-->
