...
<?php
	...
	$sql = "SELECT `result_hur400M`.`chest` , `result_hur400M`.`id` ,`STUDENT`.`roll` ,`STUDENT`.`name` ,`STUDENT`.`batch`
FROM `result_hur400M` , `STUDENT` WHERE `result_hur400M`.`chest` = `STUDENT`.`CHEST`
ORDER BY `result_hur400M`.`id`
LIMIT 0 , 3";
             ...
             <!--header section-->
               <div class="header" class="row">
                ...
                <!-- Registration form -->
                 ...
                 <div id="legend">
                <h3 class="text-center" class="subhead"><b>400 M Hurdles (MALE)</b> </h3>
                </div>
                <!--Name-->
                <div class="row" id="score">
                <div class="col-md-12">
                <div class="form-group">
                   <form method = "post" action = "add_hscore_400M_handler.php">
			<table class="table">
	<body>
				<th> POSITION </th>
				<th> CHEST NO </th>
