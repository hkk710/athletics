...
<?php
	...
	$sql = "SELECT `result_javM`.`chest` , `result_javM`.`id` ,`STUDENT`.`roll` ,`STUDENT`.`name` ,`STUDENT`.`batch`
FROM `result_javM` , `STUDENT` WHERE `result_javM`.`chest` = `STUDENT`.`CHEST`
ORDER BY `result_javM`.`id`
LIMIT 0 , 3";
             ...
             <!--header section-->
               <div class="header" class="row">
                ...
                <!-- Registration form -->
                 ...
                 <div id="legend">
                <h3 class="text-center" class="subhead"><b> Javelin Throw (MALE)</b> </h3>
                </div>
                <!--Name-->
