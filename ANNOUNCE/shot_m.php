...
<?php
	...
	$sql = "SELECT `result_shortM`.`chest` , `result_shortM`.`id` ,`STUDENT`.`roll` ,`STUDENT`.`name` ,`STUDENT`.`batch`
FROM `result_shortM` , `STUDENT` WHERE `result_shortM`.`chest` = `STUDENT`.`CHEST`
ORDER BY `result_shortM`.`id`
LIMIT 0 , 3";
             ...
             <!--header section-->
               <div class="header" class="row">
                ...
                <!-- Registration form -->
                 ...
                 <div id="legend">
                <h3 class="text-center" class="subhead"><b> Short Put (MALE)</b> </h3>
                </div>
                <!--Name-->
