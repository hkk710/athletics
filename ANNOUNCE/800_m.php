...
<?php
	...
	$sql = "SELECT `result_800M`.`chest` , `result_800M`.`id` ,`STUDENT`.`roll` ,`STUDENT`.`name` ,`STUDENT`.`batch`
MROM `result_800M` , `STUDENT` WHERE `result_800M`.`chest` = `STUDENT`.`CHEST`
ORDER BY `result_800M`.`id`
LIMIT 0 , 3";
             ...
             <!--header section-->
               <div class="header" class="row">
                ...
                <!-- Registration form -->
                 ...
                 <div id="legend">
                <h3 class="text-center" class="subhead"><b> 800m (MALE)</b> </h3>
                </div>
                <!--Name-->
