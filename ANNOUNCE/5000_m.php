...
<?php
	...
	$sql = "SELECT `result_5000M`.`chest` , `result_5000M`.`id` ,`STUDENT`.`roll` ,`STUDENT`.`name` ,`STUDENT`.`batch`
MROM `result_5000M` , `STUDENT` WHERE `result_5000M`.`chest` = `STUDENT`.`CHEST`
ORDER BY `result_5000M`.`id`
LIMIT 0 , 3";
             ...
             <!--header section-->
               <div class="header" class="row">
                ...
                <!-- Registration form -->
                 ...
                 <div id="legend">
                <h3 class="text-center" class="subhead"><b> 5000m (MALE)</b> </h3>
                </div>
                <!--Name-->
