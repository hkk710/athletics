...
<?php
	...
	$sql = "SELECT `result_hamF`.`chest` , `result_hamF`.`id` ,`STUDENT`.`roll` ,`STUDENT`.`name` ,`STUDENT`.`batch`
FROM `result_hamF` , `STUDENT` WHERE `result_hamF`.`chest` = `STUDENT`.`CHEST`
ORDER BY `result_hamF`.`id`
LIMIT 0 , 3";
             ...
             <!--header section-->
               <div class="header" class="row">
                ...
                <!-- Registration form -->
                 ...
                 <div id="legend">
                <h3 class="text-center" class="subhead"><b>Hammer Throw (FEMALE)</b> </h3>
                </div>
                <!--Name-->
