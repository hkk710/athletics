...
<?php
	...
	$sql = "SELECT `result_400M`.`chest` , `result_400M`.`id` ,`STUDENT`.`roll` ,`STUDENT`.`name` ,`STUDENT`.`batch`
MROM `result_400M` , `STUDENT` WHERE `result_400M`.`chest` = `STUDENT`.`CHEST`
ORDER BY `result_400M`.`id`
LIMIT 0 , 3";
             ...
             <!--header section-->
               <div class="header" class="row">
                ...
                <!-- Registration form -->
                 ...
                 <div id="legend">
                <h3 class="text-center" class="subhead"><b> 400m (MALE)</b> </h3>
                </div>
                <!--Name-->
