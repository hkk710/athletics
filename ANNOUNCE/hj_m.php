...
<?php
	...
	$sql = "SELECT `result_hjM`.`chest` , `result_hjM`.`id` ,`STUDENT`.`roll` ,`STUDENT`.`name` ,`STUDENT`.`batch`
FROM `result_hjM` , `STUDENT` WHERE `result_hjM`.`chest` = `STUDENT`.`CHEST`
ORDER BY `result_hjM`.`id`
LIMIT 0 , 3";
             ...
             <!--header section-->
               <div class="header" class="row">
                ...
                <!-- Registration form -->
                 ...
                 <div id="legend">
                <h3 class="text-center" class="subhead"><b>High Jump (MALE)</b> </h3>
                </div>
                <!--Name-->
