...
<?php
	...
	$sql = "SELECT `result_relay100_f`.`CHEST` , `result_relay100_f`.`SCORE` , `roll` , `name` , `batch`
FROM `result_relay100_f` , `STUDENT` WHERE `result_relay100_f`.`chest` = `STUDENT`.`CHEST`
ORDER BY `result_relay100_f`.`SCORE` 
LIMIT 0 , 3";
             ...
             <!--header section-->
               <div class="header" class="row">
                ...
                <!-- Registration form -->
                 ...
                 <div id="legend">
                <h3 class="text-center" class="subhead"> 100 * 4 RELAY FEMALE </h3>
                </div>
                <!--Name-->
...
<!--		<form method = "post" action = "add_hscore_100M_handler.php"> -->
			...
			if (mysqli_num_rows($result) != 0) {
				...
				while($row = mysqli_fetch_assoc($result)) {
					echo "<tr>";
					echo "<td>".$count++."</td>"." "."<td>".$row['CHEST']."</td>"." "."<td>".$row['name']."</td>"." "."<td>".$row['roll']."</td>"." "."<td>".$row['SCORE']."</td>";
					echo "</tr>";
