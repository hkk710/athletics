...
<?php
	...
	$sql = "SELECT `result_relay400_f`.`CHEST` , `result_relay400_f`.`SCORE` , `roll` , `name` , `batch`
FROM `result_relay400_f` , `STUDENT` WHERE `result_relay400_f`.`chest` = `STUDENT`.`CHEST`
ORDER BY `result_relay400_f`.`SCORE` 
LIMIT 0 , 3";
             ...
             <!--header section-->
               <div class="header" class="row">
                ...
                <!-- Registration form -->
                 ...
                 <div id="legend">
                <h3 class="text-center" class="subhead"> 400 * 4 RELAY FEMALE </h3>
                </div>
                <!--Name-->
