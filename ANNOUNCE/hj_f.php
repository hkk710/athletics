...
<?php
	...
	$sql = "SELECT `result_hjF`.`chest` , `result_hjF`.`id` ,`STUDENT`.`roll` ,`STUDENT`.`name` ,`STUDENT`.`batch`
FROM `result_hjF` , `STUDENT` WHERE `result_hjF`.`chest` = `STUDENT`.`CHEST`
ORDER BY `result_hjF`.`id`
LIMIT 0 , 3";
             ...
             <!--header section-->
               <div class="header" class="row">
                ...
                <!-- Registration form -->
                 ...
                 <div id="legend">
                <h3 class="text-center" class="subhead"><b>High Jump (FEMALE)</b> </h3>
                </div>
                <!--Name-->
