...
<?php
	...
	$sql = "SELECT `result_hamM`.`chest` , `result_hamM`.`id` ,`STUDENT`.`roll` ,`STUDENT`.`name` ,`STUDENT`.`batch`
FROM `result_hamM` , `STUDENT` WHERE `result_hamM`.`chest` = `STUDENT`.`CHEST`
ORDER BY `result_hamM`.`id`
LIMIT 0 , 3";
             ...
             <!--header section-->
               <div class="header" class="row">
                ...
                <!-- Registration form -->
                 ...
                 <div id="legend">
                <h3 class="text-center" class="subhead"><b>Hammer Throw (MALE)</b> </h3>
                </div>
                <!--Name-->
