...
<?php
	...
	$sql = "SELECT `result_400F`.`chest` , `result_400F`.`id` ,`STUDENT`.`roll` ,`STUDENT`.`name` ,`STUDENT`.`batch`
FROM `result_400F` , `STUDENT` WHERE `result_400F`.`chest` = `STUDENT`.`CHEST`
ORDER BY `result_400F`.`id`
LIMIT 0 , 3";
             ...
             <!--header section-->
               <div class="header" class="row">
                ...
                <!-- Registration form -->
                 ...
                 <div id="legend">
                <h3 class="text-center" class="subhead"><b> 400m (FEMALE)</b> </h3>
                </div>
                <!--Name-->
