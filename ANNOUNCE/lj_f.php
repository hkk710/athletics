...
<?php
	...
	$sql = "SELECT `result_long_F`.`chest` , `result_long_F`.`score` , `roll` , `name` , `batch`
FROM `result_long_F` , `STUDENT` WHERE `result_long_F`.`chest` = `STUDENT`.`CHEST`
ORDER BY `result_long_F`.`score` DESC
LIMIT 0 , 5";
             ...
             <!--header section-->
               <div class="header" class="row">
                ...
                <!-- Registration form -->
                 ...
                 <div id="legend">
                <h3 class="text-center" class="subhead"> LONG JUMP (FEMALE) </h3>
                </div>
                <!--Name-->
