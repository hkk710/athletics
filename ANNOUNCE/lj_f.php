...
<?php
	...
	$sql = "SELECT `result_ljF`.`chest` , `result_ljF`.`id` ,`STUDENT`.`roll` ,`STUDENT`.`name` ,`STUDENT`.`batch`
FROM `result_ljF` , `STUDENT` WHERE `result_ljF`.`chest` = `STUDENT`.`CHEST`
ORDER BY `result_ljF`.`id`
LIMIT 0 , 3";
             ...
             <!--header section-->
               <div class="header" class="row">
                ...
                <!-- Registration form -->
                 ...
                 <div id="legend">
                <h3 class="text-center" class="subhead"><b>long Jump (FEMALE)</b> </h3>
                </div>
                <!--Name-->
