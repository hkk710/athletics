...
<?php
	...
	$sql = "SELECT `STUDENT`.`name` , `STUDENT`.`roll` , `STUDENT`.`CHEST` , `STUDENT`.`batch` , `QUAL_100F`.`CHEST` , `QUAL_100F`.`TIME`
FROM `STUDENT` , `QUAL_100F`
WHERE `STUDENT`.`CHEST` = `QUAL_100F`.`CHEST`
ORDER BY `QUAL_100F`.`TIME`
LIMIT 0 , 8";
             ...
             <!--header section-->
               <div class="header" class="row">
                ...
                <!-- Registration form -->
                 ...
                 <div id="legend">
                <h3 class="text-center" class="subhead"> 100m (FEMALE) </h3>
                </div>
                <!--Name-->
