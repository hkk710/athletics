...
<?php
	...
	$sql = "SELECT `result_ljM`.`chest` , `result_ljM`.`id` ,`STUDENT`.`roll` ,`STUDENT`.`name` ,`STUDENT`.`batch`
FROM `result_ljM` , `STUDENT` WHERE `result_ljM`.`chest` = `STUDENT`.`CHEST`
ORDER BY `result_ljM`.`id`
LIMIT 0 , 3";
             ...
             <!--header section-->
               <div class="header" class="row">
                ...
                <!-- Registration form -->
                 ...
                 <div id="legend">
                <h3 class="text-center" class="subhead"><b>Long Jump (MALE)</b> </h3>
                </div>
                <!--Name-->
