...
<?php
	...
	$sql = "SELECT `result_long_M`.`chest` , `result_long_M`.`score` , `roll` , `name` , `batch`
FROM `result_long_M` , `STUDENT` WHERE `result_long_M`.`chest` = `STUDENT`.`CHEST`
ORDER BY `result_long_M`.`score` DESC
LIMIT 0 , 5";
             ...
             <!--header section-->
               <div class="header" class="row">
                ...
                <!-- Registration form -->
                 ...
                 <div id="legend">
                <h3 class="text-center" class="subhead"> LONG JUMP (MALE) </h3>
                </div>
                <!--Name-->
