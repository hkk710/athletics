...
<?php
	...
	$sql = "SELECT `result_medley_f`.`CHEST` , `result_medley_f`.`SCORE` , `roll` , `name` , `batch`
FROM `result_medley_f` , `STUDENT` WHERE `result_medley_f`.`chest` = `STUDENT`.`CHEST`
ORDER BY `result_medley_f`.`SCORE` 
LIMIT 0 , 3";
             ...
             <!--header section-->
               <div class="header" class="row">
                ...
                <!-- Registration form -->
                 ...
                 <div id="legend">
                <h3 class="text-center" class="subhead"> MEDLEY RELAY FEMALE </h3>
                </div>
                <!--Name-->
