...
<?php
	...
	$sql = "SELECT `result_100M`.`chest` , `result_100M`.`id` ,`STUDENT`.`roll` ,`STUDENT`.`name` ,`STUDENT`.`batch`
FROM `result_100M` , `STUDENT` WHERE `result_100M`.`chest` = `STUDENT`.`CHEST`
ORDER BY `result_100M`.`id`
LIMIT 0 , 3";
             ...
             <!--header section-->
               <div class="header" class="row">
                ...
                <!-- Registration form -->
                 ...
                 <div id="legend">
                <h3 class="text-center" class="subhead"><b> 100m (MALE)</b> </h3>
                </div>
                <!--Name-->
