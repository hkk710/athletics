...
<?php
	...
	$sql = "SELECT `result_javF`.`chest` , `result_javF`.`id` ,`STUDENT`.`roll` ,`STUDENT`.`name` ,`STUDENT`.`batch`
FROM `result_javF` , `STUDENT` WHERE `result_javF`.`chest` = `STUDENT`.`CHEST`
ORDER BY `result_javF`.`id`
LIMIT 0 , 3";
             ...
             <!--header section-->
               <div class="header" class="row">
                ...
                <!-- Registration form -->
                 ...
                 <div id="legend">
                <h3 class="text-center" class="subhead"><b> Javelin Throw (FEMALE)</b> </h3>
                </div>
                <!--Name-->
