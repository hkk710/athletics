...
<?php
	...
	$sql = "SELECT `result_1500F`.`chest` , `result_1500F`.`time` , `roll` , `name` , `batch`
FROM `result_1500F` , `STUDENT` WHERE `result_1500F`.`chest` = `STUDENT`.`CHEST`
ORDER BY `result_1500F`.`time`
LIMIT 0 , 5";
             ...
             <!--header section-->
               <div class="header" class="row">
                ...
                <!-- Registration form -->
                 ...
                 <div id="legend">
                <h3 class="text-center" class="subhead"> 1500m (FEMALE) </h3>
                </div>
                <!--Name-->
