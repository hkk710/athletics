...
<?php
	...
	$sql = "SELECT `discuss_F`.`chest` , `discuss_F`.`id` ,`STUDENT`.`roll` ,`STUDENT`.`name` ,`STUDENT`.`batch`
FROM `discuss_F` , `STUDENT` WHERE `discuss_F`.`chest` = `STUDENT`.`CHEST`
ORDER BY `discuss_F`.`id`
LIMIT 0 , 3";
             ...
             <!--header section-->
               <div class="header" class="row">
                ...
                <!-- Registration form -->
                 ...
                 <div id="legend">
                <h3 class="text-center" class="subhead"><b> Discuss Throw (FEMALE)</b> </h3>
                </div>
                <!--Name-->
