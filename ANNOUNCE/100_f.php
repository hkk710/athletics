...
<?php
	...
	$sql = "SELECT `result_100F`.`chest` , `result_100F`.`id` ,`STUDENT`.`roll` ,`STUDENT`.`name` ,`STUDENT`.`batch`
FROM `result_100F` , `STUDENT` WHERE `result_100F`.`chest` = `STUDENT`.`CHEST`
ORDER BY `result_100F`.`id`
LIMIT 0 , 3";
             ...
             <!--header section-->
               <div class="header" class="row">
                ...
                <!-- Registration form -->
                 ...
                 <div id="legend">
                <h3 class="text-center" class="subhead"><b> 100m (FEMALE)</b> </h3>
                </div>
                <!--Name-->
