...
<?php
	...
	$sql = "SELECT `result_relay400_m`.`CHEST` , `result_relay400_m`.`SCORE` , `roll` , `name` , `batch`
FROM `result_relay400_m` , `STUDENT` WHERE `result_relay400_m`.`chest` = `STUDENT`.`CHEST`
ORDER BY `result_relay400_m`.`SCORE` 
LIMIT 0 , 3";
             ...
             <!--header section-->
               <div class="header" class="row">
                ...
                <!-- Registration form -->
                 ...
                 <div id="legend">
                <h3 class="text-center" class="subhead"> 400 * 4 RELAY MALE </h3>
                </div>
                <!--Name-->
