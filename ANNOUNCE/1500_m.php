...
<?php
	...
	$sql = "SELECT `result_1500M`.`chest` , `result_1500M`.`id` ,`STUDENT`.`roll` ,`STUDENT`.`name` ,`STUDENT`.`batch`
MROM `result_1500M` , `STUDENT` WHERE `result_1500M`.`chest` = `STUDENT`.`CHEST`
ORDER BY `result_1500M`.`id`
LIMIT 0 , 3";
             ...
             <!--header section-->
               <div class="header" class="row">
                ...
                <!-- Registration form -->
                 ...
                 <div id="legend">
                <h3 class="text-center" class="subhead"><b> 1500m (MALE)</b> </h3>
                </div>
                <!--Name-->
