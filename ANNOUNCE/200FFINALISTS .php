...
<?php
	...
	$sql = "SELECT `STUDENT`.`name` , `STUDENT`.`roll` , `STUDENT`.`CHEST` , `STUDENT`.`batch` , `QUAL_200F`.`CHEST` , `QUAL_200F`.`TIME`
FROM `STUDENT` , `QUAL_200F`
WHERE `STUDENT`.`CHEST` = `QUAL_200F`.`CHEST`
ORDER BY `QUAL_200F`.`TIME`
LIMIT 0 , 8";
             ...
             <!--header section-->
               <div class="header" class="row">
                ...
                <!-- Registration form -->
                 ...
                 <div id="legend">
                <h3 class="text-center" class="subhead"> 200m (FEMALE) </h3>
                </div>
                <!--Name-->
