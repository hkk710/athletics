...
<?php
	...
	$sql = "SELECT `result_tjM`.`chest` , `result_tjM`.`id` ,`STUDENT`.`roll` ,`STUDENT`.`name` ,`STUDENT`.`batch`
FROM `result_tjM` , `STUDENT` WHERE `result_tjM`.`chest` = `STUDENT`.`CHEST`
ORDER BY `result_tjM`.`id`
LIMIT 0 , 3";
             ...
             <!--header section-->
               <div class="header" class="row">
                ...
                <!-- Registration form -->
                 ...
                 <div id="legend">
                <h3 class="text-center" class="subhead"><b>Triple Jump (MALE)</b> </h3>
                </div>
                <!--Name-->
