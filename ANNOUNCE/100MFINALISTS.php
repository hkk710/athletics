...
<?php
	...
	$sql = "SELECT `STUDENT`.`name` , `STUDENT`.`roll` , `STUDENT`.`CHEST` , `STUDENT`.`batch` , `QUAL_100M`.`CHEST` , `QUAL_100M`.`TIME`
FROM `STUDENT` , `QUAL_100M`
WHERE `STUDENT`.`CHEST` = `QUAL_100M`.`CHEST`
ORDER BY `QUAL_100M`.`TIME`
LIMIT 0 , 8";
             ...
             <!--header section-->
               <div class="header" class="row">
                ...
                <!-- Registration form -->
                 ...
                 <div id="legend">
                <h3 class="text-center" class="subhead"> 100m (MALE) </h3>
                </div>
                <!--Name-->
