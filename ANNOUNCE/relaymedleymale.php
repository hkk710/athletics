...
<?php
	...
	$sql = "SELECT `result_medley_m`.`CHEST` , `result_medley_m`.`SCORE` , `roll` , `name` , `batch`
FROM `result_medley_m` , `STUDENT` WHERE `result_medley_m`.`chest` = `STUDENT`.`CHEST`
ORDER BY `result_medley_m`.`SCORE` 
LIMIT 0 , 3";
             ...
             <!--header section-->
               <div class="header" class="row">
                ...
                <!-- Registration form -->
                 ...
                 <div id="legend">
                <h3 class="text-center" class="subhead"> MEDLEY RELAY MALE </h3>
                </div>
                <!--Name-->
