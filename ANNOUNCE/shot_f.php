...
<?php
	...
	$sql = "SELECT `result_shortF`.`chest` , `result_shortF`.`id` ,`STUDENT`.`roll` ,`STUDENT`.`name` ,`STUDENT`.`batch`
FROM `result_shortF` , `STUDENT` WHERE `result_shortF`.`chest` = `STUDENT`.`CHEST`
ORDER BY `result_shortF`.`id`
LIMIT 0 , 3";
             ...
             <!--header section-->
               <div class="header" class="row">
                ...
                <!-- Registration form -->
                 ...
                 <div id="legend">
                <h3 class="text-center" class="subhead"><b> Short Put (FEMALE)</b> </h3>
                </div>
                <!--Name-->
