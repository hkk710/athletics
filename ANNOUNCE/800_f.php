...
<?php
	...
	$sql = "SELECT `result_800F`.`chest` , `result_800F`.`id` ,`STUDENT`.`roll` ,`STUDENT`.`name` ,`STUDENT`.`batch`
FROM `result_800F` , `STUDENT` WHERE `result_800F`.`chest` = `STUDENT`.`CHEST`
ORDER BY `result_800F`.`id`
LIMIT 0 , 3";
             ...
             <!--header section-->
               <div class="header" class="row">
                ...
                <!-- Registration form -->
                 ...
                 <div id="legend">
                <h3 class="text-center" class="subhead"><b> 800m (FEMALE)</b> </h3>
                </div>
                <!--Name-->
