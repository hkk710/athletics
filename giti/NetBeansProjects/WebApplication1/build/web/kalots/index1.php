...
$sql2 = "SELECT * FROM `event_list` WHERE `page`=1 ";
        ...
        function title2()
{
	...
	window.location.assign("titleeditor/page2/page2.php");
}
 function title3()
{
	alert("reached title3");
	window.location.assign("titleeditor/page3/page3.php");
}
...
<a href="login.html"><img src="images/login-button.png"></a>
						<h2 onClick="title1()" style="color:<?php echo $color ?>"> <font face="<?php echo $style ?>">
    <?php echo $text ?></h2></font>
					...
					<section class="st-panel st-color" id="st-panel-2">
                        ...
                        <h2 onClick="title2()" style="color:<?php echo $color1 ?>"> 
                        <font face="<?php echo $style1 ?>">
              <?php echo $text1 ?></h2></font>>
						<p onClick="title3()" style="color:<?php echo $color2 ?>"> <font face="<?php echo $style2 ?>">
    <?php echo $text2 ?></h2></font> </p>
					</section>
